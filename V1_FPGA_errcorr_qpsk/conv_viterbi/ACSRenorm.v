// -------------------------------------------------------------
// 
// File Name: C:\Users\bryan\Downloads\viterbi\gm_hdlcoder_commviterbi\ACSRenorm.v
...
module ACSRenorm
  ...
  reg [3:0] MininputRegister_1 [0:3];  // ufix4 [4]
  reg [3:0] dstMet_reorder [0:3];  // ufix4 [4]
  wire [1:0] const_idx [0:3];  // ufix2 [4]
  wire [1:0] MinimumTree_treestage1_isless;  // boolean [2]
  ...
  always @(posedge clk or posedge reset)
    begin : stMetRegister_process
      if (reset == 1'b1) begin
        stMetRegister_1[0] <= 4'b0111;
        stMetRegister_1[1] <= 4'b0111;
        stMetRegister_1[2] <= 4'b0111;
        stMetRegister_1[3] <= 4'b0000;
  ...
  always @(posedge clk or posedge reset)
    begin : MininputRegister_process
      if (reset == 1'b1) begin
        MininputRegister_1[0] <= 4'b0111;
        MininputRegister_1[1] <= 4'b0111;
        MininputRegister_1[2] <= 4'b0111;
        MininputRegister_1[3] <= 4'b0000;

        for(MininputRegister_t_1 = 32'sd0; MininputRegister_t_1 <= 32'sd3; MininputRegister_t_1 = MininputRegister_t_1 + 32'sd1) begin
        ...
        if (enb) begin
          for(MininputRegister_t_0_0 = 32'sd0; MininputRegister_t_0_0 <= 32'sd3; MininputRegister_t_0_0 = MininputRegister_t_0_0 + 32'sd1) begin
  ...
  always @(posedge clk or posedge reset)
    begin : MinimumTree_stage1_val_1_process
      if (reset == 1'b1) begin
        for(MinimumTree_stage1_val_t_1 = 32'sd0; MinimumTree_stage1_val_t_1 <= 32'sd1; MinimumTree_stage1_val_t_1 = MinimumTree_stage1_val_t_1 + 32'sd1) begin
          MinimumTree_stage1_val_reg[MinimumTree_stage1_val_t_1] <= 4'b0000;
        end
      end
      else begin
        if (enb) begin
          for(MinimumTree_stage1_val_t_0_0 = 32'sd0; MinimumTree_stage1_val_t_0_0 <= 32'sd1; MinimumTree_stage1_val_t_0_0 = MinimumTree_stage1_val_t_0_0 + 32'sd1) begin
  ...
  always @(posedge clk or posedge reset)
    begin : MinimumTree_stage1_idx_1_process
      if (reset == 1'b1) begin
        for(MinimumTree_stage1_idx_t_1 = 32'sd0; MinimumTree_stage1_idx_t_1 <= 32'sd1; MinimumTree_stage1_idx_t_1 = MinimumTree_stage1_idx_t_1 + 32'sd1) begin
          MinimumTree_stage1_idx_reg[MinimumTree_stage1_idx_t_1] <= 2'b00;
        end
      end
      else begin
        if (enb) begin
          for(MinimumTree_stage1_idx_t_0_0 = 32'sd0; MinimumTree_stage1_idx_t_0_0 <= 32'sd1; MinimumTree_stage1_idx_t_0_0 = MinimumTree_stage1_idx_t_0_0 + 32'sd1) begin
